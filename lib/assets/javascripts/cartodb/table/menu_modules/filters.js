...
cdb.admin.mod.Filters = cdb.admin.Module.extend({
    ...
    _enablePolyDrawTool:function() {
      this.$cancelDraw.show();
      cdb.god.trigger('addGeometricFilter', 'poly');
    },
    _enableRecDrawTool:function() {
      this.$cancelDraw.show();
      cdb.god.trigger('addGeometricFilter', 'rec');
    },
    _enableCirDrawTool:function() {
      this.$cancelDraw.show();
      cdb.god.trigger('addGeometricFilter', 'cir');
    },
    ...
    setViewMode: function(viewMode){
      if(viewMode === 'table'){
        this.$el.find('.shapeFilterDiv').hide();
      }else{
        this.$el.find('.shapeFilterDiv').show();
      }
    },
    ...
    render: function() {
      ...
      this.$shapeDrawDiv = this.$el.find('.shapeFilterDiv');
      this.$cancelDraw.hide();

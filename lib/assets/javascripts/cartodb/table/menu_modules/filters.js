...
cdb.admin.mod.Filters = cdb.admin.Module.extend({
    ...
    loadScroll: function() {
      //This code was Commented out because this version on the code does not use the button scroll
      //instead it is a normal scroll bar.
      ...
      //   $scrollPane.jScrollPane({ autoReinitialise: true, showArrows: true, animateScroll: true, animateDuration: 150 });
    ...
    _showQueryAppliedMessage: function() {
      // Commented line since it was not needed.

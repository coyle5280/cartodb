(function() {
  ...
  cdb.admin.mod.SelectorFilter = cdb.core.View.extend({
      ...
      if(this.options.model.get('operations') && this.options.model.get('operations')[0] && this.options.model.get('operations')[0].metaData){
        ...
        if(filterDataObj.type === 'circle'){
          if(localStorage.getItem('units') === 'english') {
            this.radiusValDisplay = (filterDataObj.radius*0.000621371).toFixed(2) + " mi";
            this.radiusVal = (filterDataObj.radius*0.000621371).toFixed(2);
          } else {
            this.radiusValDisplay = (filterDataObj.radius/1000).toFixed(2) + " km";
            this.radiusVal = (filterDataObj.radius/1000).toFixed(2);
          }
        }else{
          if(localStorage.getItem('units') === 'english') {
            this.layerArea = (filterDataObj.layerArea*0.000621371).toFixed(2) + " mi";
          } else {
            this.layerArea = (filterDataObj.layerArea/1000).toFixed(2) + " km";
          } 
        }
      }
    ...
    //TODO Josh Need to adjust circle radius
    ...
    updateFilterView: function(e) {
      ...
      if(e.layer._mRadius){
        if(localStorage.getItem('units') === 'english'){
          this.radiusValDisplay = (e.layer._mRadius*0.000621371).toFixed(2) + "mi";
          this.radiusVal = (e.layer._mRadius*0.000621371).toFixed(2);
        }else{
          this.radiusValDisplay = (e.layer._mRadius/1000).toFixed(2) + "km";
          this.radiusVal = (e.layer._mRadius/1000).toFixed(2);
        }
      }else{
        if(localStorage.getItem('units') === 'english') {
          this.layerArea = (L.GeometryUtil.geodesicArea(e.layer._latlngs)*0.000621371).toFixed(2) + " mi";
        } else {
          this.layerArea = (L.GeometryUtil.geodesicArea(e.layer._latlngs)/1000).toFixed(2) + " km";
        }
      }
      // this.toggleShapeButtons();
      this.render();
    },

(function() {
  ...
  cdb.admin.mod.SelectorFilter = cdb.core.View.extend({
    ...
    _setupAutoComplete: function() {
      //Josh Need to adjust this call to find specific dom element not by id
    ...
    render: function() {
      ...
      //This is a hacky way to add the autocomplete listeners but the DOM element must be created first 
      setTimeout(function(){

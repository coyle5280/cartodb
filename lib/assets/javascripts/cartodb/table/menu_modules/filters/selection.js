(function() {
  ...
  cdb.admin.mod.SelectorFilter = cdb.core.View.extend({
    ...
    events: {
      ...
      'click .saveRadiusChange'            : '_saveRadiusChange',
    ...
    _editCircleRadius: function(e){
      ...
      // this.$circleRadiusText.hide();     
      // this.$circleRadiusEdit.show(); 
      // this.$circleRadiusEdit.focus();
      // this.$saveCir.show();   
      this.render();
    },
    ...
    //TODO Josh Need to disable/enable buttons when geo filter shape is added or removed
    // toggleShapeButtons: function() {
    //   if(this.displayShapeButtons){
    //     this.displayShapeButtons = false;
    //   }else{
    //     this.displayShapeButtons = true;
    //   }
    // },

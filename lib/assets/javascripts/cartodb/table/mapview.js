...
cdb.admin.MapTab = cdb.core.View.extend({
  ...
  clearMap: function() {
    ...
    if (this.exportImageView) {
      ...
      cdb.god.unbind("export_size_changed");
      cdb.god.unbind("custom_size_changed");
  ...
  _addExportBar: function(model, form_data, forceReset) {
    ...
    if (!this.exportBar) {
      ...
      this.exportBar.bind("custom_size_changed", function(event) {
        this._customSizeChanged(event);
      }, this);
  ...
  _customSizeChanged: function(event) {
    console.log(event);
  },
  ...
  _exportImage: function() {
    ...
    this.exportImageView.bind("width_height_changed", function(width, height) {
      console.log('got size change event w: ' + width + ' h: ' + height);
    }, this);

  ...
  return {
    ...
    _updateMapFilterShape: function(layerId) {
      ...
      if(!layerId){
        ...
        for(var i = 0; i < cdb.god.featureGroups.length; i++){
          if(cdb.god.featureGroups[i].active === true){
    ...
    addGeometricFilter: function(type, id){
      ...
      switch(type) {
        ...
        case 'rec':
          ...
          this.drawObj = new L.Draw.Rectangle(this.map_leaflet, {metric: metric});
          this.drawObj.enable();
          break;
        case 'polygon':
        case 'poly':
          ...
          this.drawObj = new L.Draw.Polygon(this.map_leaflet, {metric: metric});
          this.drawObj.enable();
          break;
        case 'circle':
        case 'cir':
          ...
          this.drawObj = new L.Draw.Circle(this.map_leaflet, {metric: metric,shapeOptions: {
                clickable: false
            }});
          this.drawObj.enable();
          break;
    ...
    _addGeometricToolbar: function() {
      ...
      this.map_leaflet.on('draw:created', function(e){
        ...
        if(cdb.god.featureGroups){
          this._deactivateFeatureGroups();
          cdb.god.featureGroups.push({id: cdb.god.drawLayerId, featureGroup: editableLayers, editControl: editFilterShapeControl, active: true});
        }else{
          cdb.god.featureGroups = [{id: cdb.god.drawLayerId, featureGroup: editableLayers, editControl: editFilterShapeControl, active: true}];
        }

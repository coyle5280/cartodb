  ...
  return {
    ...
    _setCircleFilterRadius: function(layerId, shapeType, newRadius){
      ...
      if(cdb.god.featureGroups){
        ...
        cdb.god.featureGroups.push({id: layerId, featureGroup: editableLayers, editControl: editFilterShapeControl, active: true});
      }else{
        cdb.god.featureGroups = [{id: layerId, featureGroup: editableLayers, editControl: editFilterShapeControl, active: true}];
      }
    },

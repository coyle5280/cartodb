...
function GrouperLayerMapView(mapViewClass) {
  ...
  return {
    ...
    initialize: function() {
      ...
      // cdb.god.on('showFilterShapeForLayer', this._showCorrectFilterShape, this);
      cdb.god.on('removeShapeFilter', this._removeShapeFilter, this);
      // cdb.god.on('noFilterShapeForLayer', this._noShapeFilter, this);
    ...
    _addGeometricToolbar: function() {
      ...
      this.map_leaflet.on('draw:created', function(e){
        ...
        if(cdb.god.featureGroups){
          cdb.god.featureGroups.push({id: this.drawLayerId, featureGroup: editableLayers, editControl: editFilterShapeControl});
        }else{
          cdb.god.featureGroups = [{id: this.drawLayerId, featureGroup: editableLayers, editControl: editFilterShapeControl}];
        }
      ...
      this.map_leaflet.on('draw:edited', function(e){
        cdb.god.trigger('removeFilter', this.layerEditId);
        var layer = null;

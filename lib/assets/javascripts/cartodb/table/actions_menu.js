  ...
  cdb.admin.LayersPanel = cdb.ui.common.TabPane.extend({
    ...
    *******/
    ...
    //TODO Josh Set Default map layer
    _setDefaultLayer: function() {
      ...
      if (layer) {
        //TODO Josh Maybe show map filter layer here if saved to map object
        //maybe place show value it switchTo function ?? maybe not
    ...
    *******/
    ...
    show: function(modName) {
      ...
      var mod = this.getActivePane();
      // cdb.god.trigger('showFilterShapeForLayer', mod.dataLayer.id);

...
cdb.admin.ExportImageView = cdb.core.View.extend({
  ...
  initialize: function() {
    ...
    _.bindAll(this, "_onResizeWindow", "_onChangeDimensions", "_onImageCallback", "_onAdvancedImageCallback", "_keydown", "_onDrag", "_onResize", "_onResizeStart", "_onResizeStop", "_updateHelpers");
  ...
  _onChangeDimensions: function() {
    ...
    console.log('_onChangeDimensions', width, height, x, y);
  ...
  _onDrag: function() {
    ...
    console.log('_onDrag', width, height, x, y);
  ...
  _onResize: function(e, ui) {
    ...
    console.log('_onResize', width, height, x, y);
    this.model.set({ x: x, y: y, width: width, height: height });
  },
